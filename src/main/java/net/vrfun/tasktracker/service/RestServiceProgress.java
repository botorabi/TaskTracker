...
public class RestServiceProgress {
    ...
    public ResponseEntity<List<Progress>> getProgressAll() {
    ...
    public ResponseEntity<List<Progress>> getTeamProgress(@PathVariable("id") final Long id) {
    ...
    public ResponseEntity<Progress> getProgress(@PathVariable("id") final Long id) {
