...
if [[ $1 == 'patch' ]]; then
    find ${FLUTTER_PATH}/../hosted/pub.dartlang.org -name "browser_client.dart" -type f -exec sed -i 's/bool withCredentials = false/bool withCredentials = true/g' {} \;
    echo "http package browser client patched!"
elif [[ $1 == "revert" ]]; then
    find ${FLUTTER_PATH}/../hosted/pub.dartlang.org -name "browser_client.dart" -type f -exec sed -i 's/bool withCredentials = true/bool withCredentials = false/g' {} \;
